  ...
  return (
    <View style={[styles.container, {backgroundColor: theme.backgroundColor}]}>
      ...
      <Text
        ...
        <Text style={{fontWeight: 'bold'}}>REMEMBER</Text> to save your{' '}
        <Text style={{fontWeight: 'bold'}}>PRIVATE KEY</Text> ! If you lose your
        private key, you will not be able to recover your wallet
      </Text>
