        ...
        <View style={styles.wrapper}>
            ...
            <View style={styles.highlight}>
                <Image
                    ...
                    source={{
                        uri: 'https://miro.medium.com/max/12000/1*OFzM1PiAeoUCXFYsbqid1Q.jpeg',
                    }}
                />
                <Text style={[styles.title, { color: theme.textColor }]}>5 Visual design tools for UX designers</Text>
                            ...
                            <View style={styles.row}>
                                <View style={styles.left}>
                                    <Image
                                        ...
                                        source={{
                                            uri: 'https://i.guim.co.uk/img/media/9e60e5e5886a7f8b0c8cbbd0d864446b25840907/0_283_5467_3280/master/5467.jpg?width=1200&height=900&quality=85&auto=format&fit=crop&s=4364b4ae7b9d9a5f0d661e2d263d24e6',
                                        }}
                                    />
                                </View>
