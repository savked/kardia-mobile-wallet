      ...
      <CardTypeModal cardAvatarID={cardAvatarID} visible={showCardTypeModal} onClose={() => setShowCardTypeModal(false)} />
        <View style={{flex: 1}}>
          ...
          <View style={{flex: 1}}>
            ...
            <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
              <Text allowFontScaling={false} style={{marginTop: 16, marginBottom: 8, fontWeight: 'normal', color: theme.textColor}}>{getLanguageString(language, 'WALLET_CARD_TYPE')}</Text>
            </TouchableWithoutFeedback>
            <View style={{ flex: 1 }}>
